...
void testFastLines(uint16_t color1, uint16_t color2) {
  unsigned long start;
  int x, y, w = ILI9341_SCREEN_WIDTH, h = ILI9341_SCREEN_HEIGHT;

  ILI9341_FillScreen(BLACK);

  for(y=0; y<h; y+=5) ILI9341_DrawHLine(0, y, w, color1);
  for(x=0; x<w; x+=5) ILI9341_DrawVLine(x, 0, h, color2);
  HAL_Delay(1000);
...
int main(void)
{
  ...
  HAL_Delay(50);
   ...
   ILI9341_DrawText("HELLO SVNIT", FONT4, 90, 110, BLACK, WHITE);
   HAL_Delay(1000);
   ...
   for(uint8_t i = 0; i <= 5; i++)
   {
     ...
     ILI9341_DrawText(BufferText, FONT3, 10, 30, BLUE, BLUE);
     ILI9341_DrawText(BufferText, FONT3, 10, 50, RED, YELLOW);
     ILI9341_DrawText(BufferText, FONT3, 10, 70, GREEN, GREEN);
     ILI9341_DrawText(BufferText, FONT3, 10, 90, YELLOW, OLIVE);
     ILI9341_DrawText(BufferText, FONT3, 10, 110, PURPLE, MAROON);
     ILI9341_DrawText(BufferText, FONT3, 10, 130, ORANGE, DARKGREY);
     ILI9341_DrawText(BufferText, FONT3, 10, 150, MAROON, CYAN);
     ILI9341_DrawText(BufferText, FONT3, 10, 170, WHITE, PINK);
  ...
  /* Infinite loop */
   ILI9341_DrawText("THANK YOU", FONT4, 90, 110, MAROON, YELLOW);
